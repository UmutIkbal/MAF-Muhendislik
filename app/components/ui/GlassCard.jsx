  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 ${image ? "flex min-h-56 flex-col justify-end" : ""}`}>
        ...
        {cardBody ? (
          <div className={image ? "service-card-body max-h-0 translate-y-2 overflow-hidden text-[#efe2cb] opacity-0 transition-all duration-300 ease-out group-hover:mt-3 group-hover:max-h-24 group-hover:translate-y-0 group-hover:opacity-100" : "text-[#efe2cb]"}>
            {cardBody}
          </div>
        ) : null}
